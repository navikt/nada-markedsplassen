...
func TestArtifactRegistryCredentialServiceRejectsNilCreateResponse(t *testing.T) {
	...
	sut := NewArtifactRegistryCredentialService(true, []string{"00000000-0000-0000-0000-000000000002"}, time.Second, stub)
...
func TestArtifactRegistryCredentialServiceCreatesToken(t *testing.T) {
	...
	sut := NewArtifactRegistryCredentialService(true, []string{
