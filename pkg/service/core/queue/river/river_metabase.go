...
func (q *metabaseQueue) CreateOpenMetabaseBigqueryDatabaseDeleteJob(ctx context.Context, datasetID uuid.UUID) (*service.MetabaseOpenBigqueryDatabaseDeleteJob, error) {
	...
	_, err = client.InsertTx(ctx, tx, &worker_args.MetabaseDeleteOpenBigqueryDatabaseJob{
		DatasetID: datasetID.String(),
	}, insertOpts)
	if err != nil {
		return nil, errs.E(errs.Database, service.CodeTransactionalQueue, op, err)
	...
	job, err := q.GetMetabaseOpenBigqueryDatabaseDeleteJob(ctx, datasetID)
	if err != nil {
		return nil, errs.E(errs.Database, service.CodeTransactionalQueue, op, err)
	}
...
func (q *metabaseQueue) GetMetabaseOpenBigqueryDatabaseDeleteJob(ctx context.Context, datasetID uuid.UUID) (*service.MetabaseOpenBigqueryDatabaseDeleteJob, error) {
	const op errs.Op = "metabaseQueue.GetMetabaseOpenBigqueryDatabaseDeleteJob"
	...
	job, err := FromRiverJob(raw.Jobs[0], func(header service.JobHeader, args worker_args.MetabaseDeleteOpenBigqueryDatabaseJob) *service.MetabaseOpenBigqueryDatabaseDeleteJob {
		return &service.MetabaseOpenBigqueryDatabaseDeleteJob{
			JobHeader: header,
			DatasetID: uuid.MustParse(args.DatasetID),
		}
	})
