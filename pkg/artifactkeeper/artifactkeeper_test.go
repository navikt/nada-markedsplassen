...
func TestClientCreatesTokenWithBearerAuth(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case r.Method == http.MethodPost && r.URL.Path == "/api/v1/service-accounts/"+serviceAccountID+"/tokens":
			...
			require.Equal(t, map[string]any{
				...
				"repository_ids":  []any{"00000000-0000-0000-0000-000000000002"},
			}, requestBody)
	...
	created, err := client.CreateToken(context.Background(), artifactkeeper.CreateTokenRequest{
		Name: "knast:test", ExpiresInDays: 1, Scopes: []string{"read:artifacts"}, RepositoryIDs: []string{"00000000-0000-0000-0000-000000000002"},
	})
	require.NoError(t, err)
