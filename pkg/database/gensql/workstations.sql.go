...
INSERT INTO workstations_url_lists (nav_ident, url, description, duration)
    VALUES ($1, $2, $3, $4)
RETURNING id, nav_ident, created_at, expires_at, url, duration, description, selected
`
...
SELECT
    id, nav_ident, created_at, expires_at, url, duration, description, selected
...
UPDATE workstations_url_lists
SET url = $1, description = $2, duration = $3, selected = $4
WHERE id = $5
RETURNING id, nav_ident, created_at, expires_at, url, duration, description, selected
`
