...
export const KnastTypology = ({ x, y, className, onpremHostsNumber, internetOpeningsNumber
    ...
    const onpremButtonClassName = disableConnectOnprem ? "absolute p-1" : "absolute border rounded border-ax-neutral-400 p-1 bg-white hover:bg-ax-accent-200 cursor-pointer"
    const internetButtonClassName = disableConnectInternet ? "absolute p-1" : "absolute border rounded border-ax-neutral-400 p-1 bg-white hover:bg-ax-accent-200 cursor-pointer"
